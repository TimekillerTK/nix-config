{inputs, ...}: {
  ...
  in {
    ...
    # All our DHCP reservations are considered secrets
    sops.secrets = let
      secrets_path = ../../../secrets/router.yml;
    in {
      reservations_home.sopsFile = secrets_path;
      reservations_guest.sopsFile = secrets_path;
      reservations_iot.sopsFile = secrets_path;
    };
