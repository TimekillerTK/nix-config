{inputs, ...}: {
  ...
  # NOTE: I think it'll be best to have home-manager configuration separate
  # and use `home-manager switch --flake .#user`
  #
  # For custom user profiles based on machine, we can create `user@hostname`
  # for example... not sure yet WIP
  flake.modules.homeManager.tk = {pkgs, ...}: {
    imports = [
